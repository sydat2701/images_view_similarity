...
data_path = 'test_img/img5'
pair_path = 'pairs/img5.txt'
...
def inference(path1, path2, name):
    # Load example images
    img0_pth = path1
    img1_pth = path2
    ...
    #dt_img1, x21, y21, x22, y22 = get_detected_img(img1_pth)
    ...
    with torch.no_grad():
        ...
        fig = make_matching_figure(img0_raw, img1_raw, mkpts0, mkpts1, color, text=text, 
                                   path='/home/nts1/users/datts/image_matching/LoFTR/res_img/'+name+'_pred'+str(pred_mini) +'.jpg')
...
for idx, line in enumerate(lines):
    ...
    inference(path1, path2, imgs[0].split('.')[0]+'_'+imgs[1].split('.')[0])
